...
export const openclassrooms2 = [
    ...
    },
    {
        id: 2,
        image: Fisheye,
        title: 'Fisheye, site accessible pour une plateforme de photographes en javascript',
    ...
    },
    {
        id: 3,
        image: Plats,
        title: "Les petits plats, projet de développement d'algorithmes de recherche en javascript",
    ...
    },
    {
        id: 5,
        image: LearnHome,
        title: "LearnHome, projet de maquettage via figma, de création de users stories et de diagrammes de cas d'usages",
        titleEn:'LearnHome, project of figma, creation of user stories and use case diagrams',
        github: '',
        demo: '',
    ...
    },
    {
        id: 6,
        image: Wealthealth,
        title: "WealthHealth, refonte en reactJs à partir d'un code jQuery d'un site d'ajout d'employés utilisant react redux",
    ...
    },
    {
        id: 7,
        image: Sportsee,
        title: "Sportsee, site FullStack ReactJs + nodeJs permettant de suivre des statistiques sportives quotidiennes via des graphiques recharts",
    ...
    },
    {
        id: 8,
        image: ArgentBank,
        title: "ArgentBank, site FullStack ReactJs + nodeJs qui permet à l'utilisateur de se conncter à son compte bancaire et d'éditer son nom d'utilisateur",
